...
type BaseAuxJob struct {
	...
	// IncomingHTLCLookup controls which HTLC asset list in the
	// commitment blob the signer uses to find the asset outputs.
	...
	// flag is flipped for script generation but the asset lookup
